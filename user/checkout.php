...
<body class="theme-desktop dark" style="">
	<div id="paymentpage-container" >
        ...
        $query = "select * from cart where username='$email'";
									...
									<div class="Field-content">
										<div class="Field-wrapper">
											...
											<?php
												...
												?>
											<div class="Field-el">
												<label><b><?php echo $totalprice ;?></b></label>
											</div>
...
<a href="orderplace.php">
									<button type="button" value="pay" class="btn btn--gradient" id="rzp-button1">Pay <span style="margin-left: 4px;">₹ <?php echo $totalprice;?></span></button>
</a>
				...
				<div id="details-view" class="">
					<div id="details-section">
						<div id="description-details">
							<div class="title title--big">SpareHub 
								<div class="title-underline"></div>
							</div>
