...
<body>
    <header class="header">
        <img src="./assets/bajaj.png" alt="Honda Logo"> <!-- Honda logo -->
        <h1>Bajaj Spare Parts Store</h1>
    ...
    <?php
       ...
       // echo $veh_type;
        $query = "select * from spare_parts where company='Bajaj' and veh_name='$ab'";
